...
const SignUp = () => {
  ...
  const register = async () => {
    ...
    try {
      await custom_axios.post(ApiConstants.USER.SIGN_UP, {
  ...
  return (
    <div className="container mx-auto">
      <div className="flex justify-center px-6 my-12">
        <div className="w-3/4 border-black flex justify-center">
          <div className="bg-white p-5 rounded-lg lg:rounded-l-none">
            <h3 className="pt-4 text-2xl mb-4 text-center">Create an Account!</h3>
